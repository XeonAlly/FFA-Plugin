...
public class CommandUtil {
    ...
    public static void registerCommand(in.ffa.project.command.Command commandObject) {
        try {
    ...
    public static void unRegisterBukkitCommand(in.ffa.project.command.Command commandObject) {
        try {
